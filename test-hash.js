...
const pass = '123456';
const nodeHash = crypto.createHash('sha256').update(pass).digest('hex');
const fallHash = sha256_fallback(pass);

console.log('Node hash:', nodeHash);
console.log('Fallback :', fallHash);
console.log('Match?', nodeHash === fallHash);
