    ...
    <div id="app" style="display:flex;height:100vh;overflow:hidden;">
      ...
      <aside id="sidebar" class="collapsed">
        ...
        <div class="sidebar-footer" style="margin-top:auto;padding:12px 16px;border-top:1px solid rgba(255,255,255,0.05);">
          ...
          <!-- Reset Button -->
          <div class="nav-item" onclick="window.FactoryReset()" style="color:var(--color-danger);margin-bottom:8px;font-weight:700;border:1px solid var(--color-danger);border-radius:var(--radius-md);">
            ...
            <span class="nav-label">Zerar Sistema</span>
          </div>
